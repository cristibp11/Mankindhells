...
public class Gestor_Remoto_Test {
	...
	@Test
	public void testSigninUserManual_correctBankAccount2() {
		Usuario expected = B1_06.B106_Lofify_TESTING.Cliente.Dominio.Gestor_Remoto.nuevoUsuarioManual("Nuevo usuario",
				"Contraseña nueva", "Nombre", "Apellidos", (long) 10.0, "nuevo@email.com");
	...
	@Test
	public void loginUser_CorrectAtributes() {
		Usuario actual = B1_06.B106_Lofify_TESTING.Cliente.Dominio.Gestor_Remoto.loginUsuario("Usuarioser", "Usuarioser");
		assertNotNull(actual);
	}

	@Test
	public void testRemoveUser_Exist() {
		Usuario expected = new Usuario("Piss", "CristiBolsas", "Cristina", "Bolanos Perez", (long) 1234,
