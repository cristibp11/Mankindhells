...
public class Gestor_Dominio_Test {
	...
	@Test
	public void testModifySongSongIs() throws ClassNotFoundException, SQLException {
	...
	@Test
	public void testModifySongSongIsnt() throws ClassNotFoundException, SQLException {
		Artista a = new Artista("Kinder Malo", "Artista de trap rollo sadboy");
		Album b = new Album(a, "Sad Boy", 10.0);
	...
	@Test
	public void testModifySongNull() throws ClassNotFoundException, SQLException {
		Cancion actual = null;
	...
	@Test
	public void testRemoveSongIs() throws SQLException {
		Artista a = new Artista("Kinder Malo", "Artista de trap rollo sadboy");
		Album b = new Album(a, "Sad Boy", 10.0);
	...
	@Test
	public void testRemoveSongIsnt() throws SQLException {
	...
	@Test
	public void testRemoveSongNull() throws SQLException {
		Artista a = new Artista("Cafe Quijano", "Merengueo a tope");
		Album b = new Album(a, "La Taberna Del Buda", 8.0);
	...
	@Test
	public void testRemoveAlbumIs() throws SQLException {
		Artista a = new Artista("Kinder Malo", "Artista de trap rollo sadboy");
	...
	@Test
	public void testRemoveAlbumIsnt() throws SQLException {
		Artista a = new Artista("Kinder Malo", "Artista de trap rollo sadboy");
		Album actual = new Album(a, "Prometo", 10.0);
		Gestor_Dominio.eliminarAlbum(actual);
		assertNull(Gestor_Dominio.buscarAlbum(actual.getNombre()));
	...
	@Test
	public void testRemoveAlbumNull() throws SQLException {
		Artista a = new Artista("Kinder Malo", "Artista de trap rollo sadboy");
	...
	@Test
	public void testRemoveArtistIs() throws SQLException {
	...
	@Test
	public void testRemoveArtistIsnt() throws SQLException {
	...
	@Test
	public void testRemoveArtistNull() throws SQLException {
